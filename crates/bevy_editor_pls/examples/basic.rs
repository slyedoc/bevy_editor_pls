use bevy::{
    diagnostic::{EntityCountDiagnosticsPlugin, FrameTimeDiagnosticsPlugin}, math::vec2, prelude::*, render::{
...
fn setup(
    ...
    commands.spawn(PbrBundle {
        ...
        mesh: meshes.add(Plane3d::new(Vec3::Y, vec2(2.5, 2.5)).mesh().size(5.0, 5.0)),
